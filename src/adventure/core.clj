...
(defn describe
	...
	(let [self (:adventurer state)
		...
		(case target
			...
			:hp						(str "You have " (get-in state [:adventurer :hp]) " HP.") 
			"Nani?"
		)
	)
)
